...
public class SliderAdapterProposedProducts extends
        SliderViewAdapter<SliderAdapterProposedProducts.SliderAdapterVH> {

    private Context context;
    private List<Product> data;
    private OnRV_ClickListener_Product listener;

    public SliderAdapterProposedProducts(Context context, List<Product> mSliderItems, OnRV_ClickListener_Product listener) {
    ...
    public SliderAdapterVH onCreateViewHolder(ViewGroup parent) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.image_slider__proposed_products_adapter_layout, null);
    ...
    static class SliderAdapterVH extends ViewHolder {
        ...
        public SliderAdapterVH(View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.iv_auto_image_slider2);
            textView = itemView.findViewById(R.id.tv_auto_image_slider2);
        }
    }
